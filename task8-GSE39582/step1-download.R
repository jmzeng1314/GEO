...
### Date: 2019-04-01 18:28:24
### Email: jmzeng1314@163.com
### Blog: http://www.bio-info-trainee.com/
### Forum:  http://www.biotrainee.com/thread-1376-1-1.html
### CAFS/SUSTC/Eli Lilly/University of Macau
### Update Log:  2019-04-01  First version
###
### ---------------
...
## 挑选一些感兴趣的临床表型。
pd=pd[,apply(pd, 2, function(x) length(table(x))>2)]
pd=pd[,apply(pd, 2, function(x) length(table(x))<10)]
...
save(dat,pd,file = 'step1-output.Rdata')
